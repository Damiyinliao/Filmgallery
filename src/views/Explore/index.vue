    ...
    <div id="explore">
        <div class="feeds-page">
            <div class="feeds-wrapper">
                <section class="note-item" v-for="item in noteList" :key="item.id">
                    <img :src=item.img_url_list[0] @click="toInfoCard(item.id)">
                    <div class="footer">
                        <a href="" class="title">
