                ...
                <ul>
                    ...
                    <li>
                        ...
                        <span>
                            ...
                            <!-- <span class="picture-tag">
                                <span style="margin-top: 1px;display: flex;place-content: center;align-items: center;">
                                    <img src="./images/unchecked-circle.png" style="width: 12px;opacity: 0.6;margin-top: 1.9px;">General Purpose</span>
                            </span> -->
                        </span>
                    </li>
                    <!-- <li>
                        <img src="./images/document.png">
                        <span><a href="">Fuji C200 Datasheet</a> </span>
                        <img src="./images/external-link.png" style="width: 15px;margin-left: 4px;opacity: 0.2;margin-bottom: 1px;">
                    </li> -->
                    <!-- <li>
                        <img src="./images/time-search.png">
                        <span>Standardized C-41 Process</span>
                    </li> -->
                    <li>
            ...
            <div class="photo-wrapper card">
                ...
                <div class="photo-grid">
                    <div class="photo-item">
                        <img src="./images/样张.jpg" alt="" srcset="">
                        <div class="image-credit">
                            <a href=""><span>📷 Dane </span></a>
                        </div>
                    </div>
                    <div class="photo-item">
                        <img src="./images/样张.jpg" alt="" srcset="">
...
onMounted(() => {
    store.dispatch("getFilmInfo", route.params.id)
})
const filmInfo = computed(()=>{
    return store.state.filmInfo
})
</script>
