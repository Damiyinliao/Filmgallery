        ...
        <div class="right">
          <h1 style="font-size: 22px; text-align: center;">
            ...
            <svg style="cursor: pointer;" @click="status.code = !status.code" t="1677224437312" class="icon"
              viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2300" width="20" height="20">
              <path
          ...
          <div class="input-container">
            ...
            <label class="auth-code" v-show="!status.code">
              ...
              <span v-html="captchaCode" @click="resetCaptchaCode"></span>
            </label>
...
const captchaCode = computed(() => {
  return store.state.user.captchaCode;
})
const getCaptchCode = () => {
...
const login = async () => {
  let res = await $API.reqUserLogin({
    username: user.phoneNumber,
    password: user.password
  })
  console.log(res);
